...
export const COMMON_EVENTS = [
  ...
  { 
    ...
    tableIcon: '⚔️',
    effects: {
      success: 'Группа может разрядить ловушку или напасть (если это ловушка-встреча) с раундом сюрприза, либо обойти её тихо.',
      fail: 'Ловушка сработает. Если никто не преуспел и ловушка не является похищением, вся группа умирает.',
  ...
  { 
    ...
    description: 'Группа проходит невероятные бескрайние пейзажи, они одновременно и величественные, и вдохновляющие, и устрашающие.',
    checkInfo: '🔍 Все в группе совершают Проверку Искры.',
    effects: {
...
export const ROLE_EVENTS = {
  ...
  'Коготь_Акрепы': [
    ...
    { 
      id: 3, 
      title: 'Следы Великих', 
      description: 'В путешествии группа наталкивается на огромные следы.',
      checkInfo: '🔍 Коготь Акрепы совершает проверку Выживание.',
      hasTable: true,
  ...
  'Глаза_Звезд': [
    ...
    { 
      ...
      description: 'Что-то опасное двигается прямо в вашу сторону, слишком поздно бежать.',
      checkInfo: '🔍 Глаза Звезд совершает проверку Внимательности.',
      hasTable: true,
  ...
  'Длань_Батрины': [
    ...
    { 
      ...
      description: 'Что-то не так вокруг с животными в окружении искателей, что-то влияет на них.',
      checkInfo: '🔍 Длань Батрины совершает проверку Ухода за Животными.',
      hasTable: true,
    ...
    { 
      ...
      effects: {
        ...
        crit_fail: 'Звери намертво застыли от страха. То, что они чувствовали, набрасывается на группу.'
      }
    },
    { 
      id: 4, 
