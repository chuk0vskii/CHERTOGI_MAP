  ...
  { 
    ...
    config: {
      ...
      secondCheck: {
        ...
        results: [
          { condition: 'success_5', message: 'Группа находит 2 ценных артефакта.' },
          { condition: 'success', message: 'Тень Нарара находит магический предмет.' },
          ...
          { condition: 'fail_5', message: 'Тень Нарара задерживается среди руин, а группа привлекает внимание жителей местности.' }
        ]
      }
    }
  },
  ...
  { 
    ...
    config: {
      ...
      check: {
        ...
        results: [
          { condition: 'success_5', message: 'Чтец замечает следы поверженного зверя, зараженного тьмой, но что-то гораздо больше и сильнее убило его. Видя это поверженное создание тьмы, группа получает преимущество на проверку Искры до конца фазы Путь и +1 на Прибытие.', effects: { arrival: 1 }, table: 'great_beasts', label: 'Таблица Великих Зверей', fields: ['name'], isCreature: true },
          ...
          { condition: 'fail_5', message: 'Группа получает штраф -1 на Прибытие. Они забрели слишком далеко в логово зла, не заметив этого и пробуждая то, что спит в этих землях.', effects: { arrival: -1 } }
        ]
      }
    }
  },
    ...
    config: {
      ...
      check: {
        ...
        results: [
          ...
          { condition: 'fail_5', message: 'Ваш лагерь расположен прямо в логове монстра.' }
        ]
      }
    }
  }
