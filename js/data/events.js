...
export const COMMON_EVENTS = [
  ...
  { 
    id: 2, 
    title: 'Ловушка', 
    description: 'Что-то здесь не так. Вся группа должна совершить бросок роли, выбирая наименьший показатель из своих навыков. Смотрите Таблицу Ловушек.',
  ...
  { 
    id: 3, 
    title: 'Древние Руины', 
    description: 'Группа набредает на древнее строение. Киньте по Таблице Руин чтобы определить какого типа.',
  ...
  { 
    ...
    description: 'Группа прибывает в безопасный на вид оазис. Сделайте бросок 1к6 по таблице Загадок Оазисов.',
    checkInfo: '🔍 Все в группе совершают Проверку Искры.',
    hasTable: true,
...
export const ROLE_EVENTS = {
  'Чтец_Знаков': [
    { 
      ...
      description: 'Группа забрела в темные земли с бушующими в них неизвестными силами. Бросьте по таблице Проклятий области.',
    ...
    { 
      id: 2, 
      title: 'Преграда', 
      description: 'Что-то мешает группе пройти дальше. Используйте Таблицу Преград Области.',
  ...
  'Тень_Нарара': [
    { 
      ...
      description: 'Что-то есть на вашем пути. Используйте Таблицу Конфликт Зоны.',
    ...
    { 
      id: 2, 
      title: 'Плачь Вуали', 
      description: 'Движение вуали в регионе привлекает существ. Бросьте по таблице Дети Вуали.',
      checkInfo: '🔍 Тень Нарара совершает проверку Скрытности.',
      hasTable: true,
  ...
  'Коготь_Акрепы': [
    { 
      ...
      description: 'Провизия кончается быстро. Проклятие ли это злых духов, или просто неудача.',
    ...
    { 
      id: 3, 
      title: 'Следы Великих', 
      description: 'Группа наталкивается на огромные следы. Бросьте по Таблице Великих Странствующих Зверей.',
      checkInfo: '🔍 Коготь Акрепы совершает проверку Выживание.',
      hasTable: true,
    ...
    { 
      ...
      description: 'Охота удачна, но мясо оказывается ядовитым. Бросьте по таблице Паразитов.',
  ...
  'Длань_Батрины': [
    { 
      id: 1, 
      title: 'Бешенство', 
      description: 'С животными что-то не так, будто что-то терзает их разум.',
    ...
    { 
      ...
      description: 'Что-то не так вокруг с животными в окружении искателей. Бросьте по Таблице Смертельная Встреча.',
      checkInfo: '🔍 Длань Батрины совершает проверку Ухода за Животными.',
      hasTable: true,
