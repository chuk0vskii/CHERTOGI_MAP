...
export const ROLE_EVENTS = {
  'Чтец_Знаков': [
    ...
    { 
      id: 3, 
      title: 'Поющие Знаки', 
      description: 'Нити судьбы пытаются обречь группу на провал.',
      checkInfo: '🔍 Чтец Знаков совершает проверку Традиции.',
      effects: {
    ...
    { 
      id: 5, 
      title: 'Ложные Нити', 
      description: 'Иллюзия судьбы ведёт группу в неверном направлении и к опасности.',
  ...
  'Тень_Нарара': [
    ...
    { 
      ...
      description: 'Реальность изламывается и рвется, словно некая сила пытается проникнуть в мир.',
      checkInfo: '🔍 Тень Нарара совершает проверку Скрытности.',
      hasSubRoll: true,
  ...
  'Глаза_Звезд': [
    ...
    { 
      ...
      checkInfo: '🔍 Глаза Звезд совершает проверку Внимательности.',
      hasSubRoll: true,
      subRollType: 'dangerous_creatures',
      effects: {
  ...
  'Длань_Батрины': [
    ...
    { 
      ...
      description: 'Что-то не так вокруг с животными в окружении искателей.',
      checkInfo: '🔍 Длань Батрины совершает проверку Ухода за Животными.',
      hasSubRoll: true,
